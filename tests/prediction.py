...
from database.students import get_students_index, get_students_suggestions, get_students_grades, get_distances_matrix, get_grades_prediction, DEBUG_get_grades_prediction
...
(DEBUG_grades_prediction, DEBUG_student_similarity) = DEBUG_get_grades_prediction(filtered_grades, filtered_distances)
DEBUG_students = array_interleave(DEBUG_grades_prediction, DEBUG_student_similarity, axis=1)

DEBUG_print = np.concatenate([filtered_grades[..., np.newaxis], DEBUG_students, grades_prediction[..., np.newaxis], grades_similarity[..., np.newaxis]], axis=1)
